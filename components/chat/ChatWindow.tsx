      ...
      <div className="px-6 py-4 border-t border-gray-800 bg-gray-900">
          ...
          <div className="flex flex-wrap gap-2 mb-3">
            {attachedFiles.map((f) => (
              ...
              >
                ...
                <span className="text-gray-200 truncate max-w-[160px]">{f.name}</span>
        ...
        <div className="flex items-end gap-3">
          <button
            ...
            className="w-10 h-10 bg-gray-800 hover:bg-gray-700 disabled:opacity-40 disabled:cursor-not-allowed text-gray-400 hover:text-gray-200 rounded-xl flex items-center justify-center transition flex-shrink-0 border border-gray-700"
